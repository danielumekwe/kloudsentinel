...
class LocalFileRemediator:
    ...
    async def quarantine(self, *, relative_path: RelativeFilePath) -> QuarantinedFile:
        ...
        quarantined = _quarantine_ops.quarantine_file(source, quarantine_dir=self._quarantine_root)
        logger.info(
    ...
    async def restore(
        self, *, relative_path: RelativeFilePath, quarantine_path: str, mode: str
    ) -> None:
